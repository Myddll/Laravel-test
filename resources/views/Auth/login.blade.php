    ...
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form action="{{route("login_process")}}" method="POST" class="space-y-5 mt-5">
                ...
                <div>
                    <a href="{{ route("forgot") }}" class="font-medium text-amber-600 hover:bg-amber-100 rounded-md p-2">Забыли пароль?</a>
                </div>

                <div class="flex justify-between">
                    <a href="{{ route("register") }}" class="font-medium text-amber-600 hover:bg-amber-100 rounded-md p-2">Регистрация</a>
